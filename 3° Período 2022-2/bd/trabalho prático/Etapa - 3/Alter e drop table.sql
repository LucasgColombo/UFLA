...
CREATE TABLE IF NOT EXISTS `mydb`.`Pessoa` (
  ...
  `Complemento` VARCHAR(45) DEFAULT 'Sem complemento', -- Adicionando a restrição DEFAULT
  PRIMARY KEY (`CPF`))
ENGINE = InnoDB;
-- Adicionando a coluna DataNascimento na tabela Pessoa 
ALTER TABLE `mydb`.`Pessoa`
DROP COLUMN `DataNascimento`;
ALTER TABLE `mydb`.`Pessoa`
 ADD COLUMN `DataNascimento` DATE NOT NULL FIRST;

-- Modificando a coluna Nome 
ALTER TABLE `mydb`.`Pessoa`
MODIFY COLUMN `NomeSocial` VARCHAR(50) NOT NULL;
-- 
...
-- ALTERANDO O NOME DA TABELA ALUNO 
